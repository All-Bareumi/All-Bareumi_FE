...
//
//   SentenceData(this.subject, this.sentence, String selectedCharacter,
//       String video) {
//     this.videoPath =
//         "video/sentence/${this.subject}/${selectedCharacter}/" +
//             video + ".mp4";
//   }
// }
//
...
//   "school4",
// ];
// String selectingCharacter = "elsa";
// final List<SentenceData> foodSentences = List.generate(
//     foodSentenceList.length,
//         (idx) =>
//         SentenceData(
//             "food", foodSentenceList[idx], selectingCharacter,
...
//         (idx) =>
//         SentenceData(
//             "exercise", exerciseSentenceList[idx], selectingCharacter,
...
//         (idx) =>
//         SentenceData(
//             "family", familySentenceList[idx], selectingCharacter,
...
//         (idx) =>
//         SentenceData(
//             "school", schoolSentenceList[idx], selectingCharacter,
